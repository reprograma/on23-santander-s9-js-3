...
function fillpage(series) {
  series.forEach((serie)=>{
   const card = document.createElement("section")
    ...
    genders.innerHTML = `Gênero: <span class="dynamic-text">${serie.generos.join(' - ')}</span>`
...
// <p class="contents"Ano: <span class="dynamic-text">${serie.ano}</span>
// <p class="contents"Direção: <span class="dynamic-text">${serie.diretor}</span>
// <p class="contents"Gênero: <span class="dynamic-text">${serie.generos.join(' - ')}</span>
// <p class="contents"Elenco: <span class="dynamic-text">${serie.elenco.join(' - ')}</span>
