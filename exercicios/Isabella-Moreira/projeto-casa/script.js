...
function criarCards(serie){
  ...
  titulo.textContent = serie.titulo + ' (' + serie.ano + ')';
  ...
  generos.textContent = 'Gêneros: ' + serie.generos;
  card.appendChild(generos);

  var elenco = document.createElement('p');
  elenco.textContent = 'Elenco: '+ serie.elenco;
  card.appendChild(elenco);

  var link = document.createElement('a');
  link.href = serie.instagram;
