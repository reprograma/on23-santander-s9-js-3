...
function fillPage(series) {
  series.map((serie) => {
    ...
    cast.innerHTML = `Elenco: <span class"dynamic-text">${serie.elenco}</span>`
  ...
  }) //o que eu quiser fazer com "serie" vai se repetir pra todas//
  //o que tem dentro da função do map vai se repetir pra todos os elementos, porque ele vai percorrer todos os elementos//
